 ...
 */
public final class QpaasPathDependenciesDigester
    extends AbstractDigester
{
    private static final Digester INSTANCE = new QpaasPathDependenciesDigester();
    ...
    private QpaasPathDependenciesDigester()
    {
